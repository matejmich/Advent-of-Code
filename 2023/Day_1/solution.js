...
function genNumber(line) {
    const  chars = line.split("")
    let firstCh
    let secondCh
    
    for(j = 0; j < chars.length ; j++) {
        if(!isNaN(parseFloat(chars[j]))) {
    ...
    if (secondCh === undefined) {
        return parseFloat(firstCh + firstCh)
    } else {
    return parseFloat(firstCh + secondCh)
...
function genNumber(line) {
    ...
    if (secondCh === undefined) {
        console.log(parseFloat(firstCh + firstCh))
        return parseFloat(firstCh + firstCh)
    } else {
        console.log(parseFloat(firstCh + secondCh))
    return parseFloat(firstCh + secondCh)
...
function numberfy(string) {
    ...
    const replacedString = string.replace("zero", "0").replace("one", "1").replace("two","2").replace("three","3").replace("four","4").replace("five","5").replace("six","6").replace("seven","7").replace("eight","8").replace("nine","9");
...
function secondPart(input) {
    ...
    let sum = 0
    for (let i = 0; i < lines.length; i++) {
        sum += genNumber(numberfy(lines[i]))

    }
    return sum
}

const testtest = `two1nine
eightwothree
abcone2threexyz
xtwone3four
4nineeightseven2
zoneight234
7pqrstsixteen`
console.log(numberfy(testtest))
console.log(secondPart(testtest))